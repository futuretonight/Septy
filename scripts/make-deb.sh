...
Maintainer: @htr-tech
Depends: ${_depend}
Homepage: https://github.com/futuretonight/septy
Description: A cross-over tool of Zphisher & url-masking. This Tool is made for educational purpose only !
CONTROL_EOF
...
cp -fr .github/ .sites/ LICENSE README.md septy.sh ./build_env/$_opt_dir
